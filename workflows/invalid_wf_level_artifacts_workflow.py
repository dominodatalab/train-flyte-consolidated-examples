...
ReportArtifactBar1 = Artifact("", REPORT)
ReportArtifactBar2 = Artifact("myreport", DDict("myreport"))
...
def wf() -> Tuple[
    ...
    ReportArtifactBar1.File(name="report3.pdf", type="pdf"),
    ReportArtifactBar1.File(name="report4.pdf", type="pdf"),
    ReportArtifactBar2.File(name="report5.pdf", type="pdf"),
    ReportArtifactBar2.File(name="report6.pdf", type="pdf"),
